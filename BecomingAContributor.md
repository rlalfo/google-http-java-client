...
If you get an HTTP `403 Forbidden` status code, you are not on the list at https://code.google.com/p/google-http-java-client/people/list. Ask one of the Owners to add you to the list as a Committer.
